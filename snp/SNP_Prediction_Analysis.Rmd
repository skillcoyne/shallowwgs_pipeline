...
ggplot(subset(qcdata,SampleType == 'BE'), aes(Purity, ASCAT.SCA.ratio, color=Status, group=Status)) + geom_point() + facet_grid(~Status, scales = 'free') + ylim(0,0.005) + 
  geom_hline(yintercept = x) + geom_text(data=anno, aes(x, y, label=label), nudge_y = 0.0001) +
