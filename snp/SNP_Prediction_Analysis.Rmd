...
ggsave(filename='plots/snp/auc_ex_lowsca_roc.png', plot = roc.plot(rocpp) + labs(title='BE biopsies', subtitle='excluding low SCA samples') + theme(text=element_text(size=12)), width=4, height=4, units='in', dpi=300)
...
ggsave(filename='plots/snp/auc_t1_roc.png', plot=roc.plot(roct1) + labs(title='BE biopsies', subtitle='Timepoint T1') + theme(text=element_text(size=12)), width=4, height=4, units='in', dpi=300)
...
ggsave(filename='plots/snp/auc_t2_roc.png', plot=roc.plot(roct2) + labs(title='BE biopsies', subtitle='Timepoint T2') + theme(text=element_text(size=12)), width=4, height=4, units='in', dpi=300)
