...
But what if I, as a quick test, normalize the validation cohort with itself? This looks better here, but when I use this for predictions it doesn't significantly change the results.
...
wt.sds = sapply(sds, function(x) weighted.mean(x,global.sd,w=c(0.2)))
